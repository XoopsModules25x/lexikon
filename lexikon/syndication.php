<?php
/**
 * $Id: syndication.php v 1.0 18 Dec 2011 Yerres Exp $
...
$resultZ = $xoopsDB -> query("SELECT a.entryID, a.categoryID, a.term, a.definition, a.offline, b.* FROM " . $xoopsDB->prefix("lxentries") . " a, ".$xoopsDB->prefix('group_permission')." b WHERE a.categoryID = b.gperm_itemid AND b.gperm_modid = $module_id AND b.gperm_name = \"lexikon_view\" AND b.gperm_groupid = $groups[0]  AND a.datesub < ".time()." AND a.offline = '0' AND a.submit = '0' LIMIT $entrynumber, 1");
...
$tpl->display( "db:lx_syndication.html" ) ;
?>