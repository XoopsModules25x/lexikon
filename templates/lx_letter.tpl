...
<div id="moduleheader">
    ...
    <{if $pagetype|default:'' == '0'}>
        ...
        <{foreach item=eachentry from=$entriesarray.single}>
            <h4 class="term"><{$eachentry.microlinks}><a href="<{$xoops_url}>/modules/<{$eachentry.dir}>/entry.php?entryID=<{$eachentry.id}>"><{$eachentry.term}></a>&nbsp;<{if $multicats|default:0 == 1}>
            <a class="catname_min" href="<{$xoops_url}>/modules/<{$eachentry.dir}>/category.php?categoryID=<{$eachentry.catid}>">[&nbsp;<{$eachentry.catname}>&nbsp;]</a>
            </h4><{/if}>
            <{if $eachentry.definition|default:false}>
                <div class="definition"><{$eachentry.definition}></div><{/if}>
            <{if $eachentry.comments|default:false}>
    ...
    <{elseif $pagetype|default:'' == '1'}>
        ...
        <{foreach item=eachentry from=$entriesarray2.single}>
            <h4 class="term" style="clear:both;"><{$eachentry.microlinks}><a href="<{$xoops_url}>/modules/<{$eachentry.dir}>/entry.php?entryID=<{$eachentry.id}>"><{$eachentry.term}></a>&nbsp;<{if $multicats|default:0 == 1}>
            <a class="catname_min" href="<{$xoops_url}>/modules/<{$eachentry.dir}>/category.php?categoryID=<{$eachentry.catid}>">[&nbsp;<{$eachentry.catname}>&nbsp;]</a>
            </h4><{/if}>
            <{if $eachentry.definition|default:false}>
                <div class="definition"><{$eachentry.definition}></div><{/if}>
