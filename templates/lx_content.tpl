<div id="moduleheader">
    <div class="leftheader">
        <a href="<{$xoops_url}>"><{$smarty.const._MD_LEXIKON_HOME}></a>&nbsp;<img src='assets/images/arrow.gif' style="vertical-align:middle;" alt="<{$lang_modulename}>">
    </div>
                ...
                <tr>
                    <td>
                        <table style="border-spacing: 2px; padding: 3px;">
                            <P><br>
                                <tr>
                                    <td style="text-align: left; line-height: 200%; width:160px;">
                                        <i><{$yform.elements.txt.caption}></i><img src='assets/images/arrow.gif' style="vertical-align:middle;" alt="<{$lang_modulename}>">
                                    </td>
