<div id="moduleheader">
<div class="leftheader"><a href="<{$xoops_url}>"><{$smarty.const._MD_LEXIKON_HOME}></a>&nbsp;<img src='assets/images/arrow.gif' style="vertical-align:middle;" alt="<{$lang_modulename}>" /><!--&nbsp;<a href="<{$xoops_url}>/modules/<{$lang_moduledirname}>/"><{$lang_modulename}></a>&nbsp;<img src='assets/images/arrow.gif' style="vertical-align:middle;" alt="<{$lang_modulename}>" />-->&nbsp;<{$smarty.const._MD_LEXIKON_SYNDICATION}></div>
...
<iframe style="background-color: #FFFFFF"; src="<{$xoops_url}>/modules/<{$lang_moduledirname}>/syndication.php" frameborder="0" width="240"  height="220" allowtransparency="true" topmargin="0" leftmargin="0" scrolling='no' marginwidth="0" marginheight="0"/>[Your user agent does not support frames or is currently configured not to display frames.]</iframe>
</div>
</td></tr>
<tr><td><hr />
<table style="border-spacing: 2px; padding: 3px;">
