    ...
    <div class="clearer2">
        <{foreach item=eachresult from=$resultset.match|default:null}>
            <h4><img src="<{$xoops_url}>/modules/<{$eachresult.dir}>/assets/images/lx.png">&nbsp;<{$eachresult.microlinks}>
                &nbsp;<a href="<{$xoops_url}>/modules/<{$eachresult.dir}>/entry.php?entryID=<{$eachresult.id}><{if $highlight == 1}><{$eachresult.keywords}><{/if}>"><{$eachresult.term}></a><{if $multicats|default:0 == 1}>
