...
<div style='width: auto;height:100%; border: 1px solid #ccc; padding: 4px;'>
    ...
    <{/if}>
    <h4 style='margin: 0;text-align:left;font-family:verdana,arial, sans-serif; font-size:normal;'><A STYLE='color:#000;font-weight:bold;text-decoration:none;' TARGET='_blank' HREF="<{$xoops_url}>/modules/<{$lang_moduledirname}>/entry.php?entryID=<{$syndication.id}>"><{$syndication.term}></A></h4>
