...
$modversion['notification']['category'][1]['subscribe_from'] = ['index.php', 'category.php', 'entry.php'];
...
$modversion['notification']['category'][2]['subscribe_from'] = ['category.php', 'entry.php'];
