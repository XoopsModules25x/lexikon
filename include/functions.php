...
function lx_serviceLinks($variable)
{
    ...
    if ($xoopsUser) {
        if ($xoopsUser->isAdmin()) {
            $srvlinks .= "<a TITLE=\"" . _EDIT . "\" href=\"admin/entry.php?op=mod&entryID=" . $variable['id'] . "\" target=\"_blank\"><img src=\"" . $pathIcon16 . "/edit.png\"   border=\"0\" alt=\"" . _MD_LEXIKON_EDITTERM
                         . "\" width=\"16\" height=\"16\"></a>&nbsp;<a TITLE=\"" . _DELETE . "\" href=\"admin/entry.php?op=del&entryID=" . $variable['id'] . "\" target=\"_self\"><img src=\"" . $pathIcon16 . "/delete.png\"   border=\"0\" alt=\""
                         . _MD_LEXIKON_DELTERM . "\" width=\"16\" height=\"16\"></a>&nbsp;";
        }
    }
    if ($entrytype != '1') {
        $srvlinks .= "<a TITLE=\"" . _MD_LEXIKON_PRINTTERM . "\" href=\"print.php?entryID=" . $variable['id'] . "\" target=\"_blank\"><img src=\"" . $pathIcon16 . "/printer.png\"    border=\"0\" alt=\"" . _MD_LEXIKON_PRINTTERM
                     . "\" width=\"16\" height=\"16\"></a>&nbsp;<a TITLE=\"" . _MD_LEXIKON_SENDTOFRIEND . "\" href=\"mailto:?subject=" . sprintf(_MD_LEXIKON_INTENTRY, $xoopsConfig['sitename']) . '&amp;body=' . sprintf(_MD_LEXIKON_INTENTRYFOUND,
                                                                                                                                                                                                                          $xoopsConfig['sitename']) . ': '
                     . XOOPS_URL . '/modules/' . $xoopsModule->dirname() . '/entry.php?entryID=' . $variable['id'] . " \" target=\"_blank\"><img src=\"" . $pathIcon16 . "/mail_replay.png\"   border=\"0\" alt=\"" . _MD_LEXIKON_SENDTOFRIEND
                     . "\" width=\"16\" height=\"16\"></a>&nbsp;";
        if (($xoopsModuleConfig['com_rule'] != 0)
            && (!empty($xoopsModuleConfig['com_anonpost'])
                || is_object($xoopsUser))
        ) {
            $srvlinks .= "<a TITLE=\"" . _COMMENTS . "?\" href=\"comment_new.php?com_itemid=" . $variable['id'] . "\" target=\"_parent\"><img src=\"assets/images/comments.gif\" border=\"0\" alt=\"" . _COMMENTS
                         . "?\" width=\"16\" height=\"16\"></a>&nbsp;";
        }
    }
...
function lx_serviceLinksnew($variable)
{
    ...
    $srvlinks2 = "<a TITLE=\"" . _MD_LEXIKON_PRINTTERM . "\" href=\"print.php?entryID=" . $variable['id'] . "\" target=\"_blank\"><img src=\"assets/images/print.gif\" border=\"0\" alt=\"" . _MD_LEXIKON_PRINTTERM
                 . "\" align=\"absmiddle\" width=\"16\" height=\"16\" hspace=\"2\" vspace=\"4\"> " . _MD_LEXIKON_PRINTTERM2 . "</a>&nbsp; <a TITLE=\"" . _MD_LEXIKON_SENDTOFRIEND . "\" href=\"mailto:?subject=" . sprintf(_MD_LEXIKON_INTENTRY,
                                                                                                                                                                                                                           $xoopsConfig['sitename'])
                 . '&amp;body=' . sprintf(_MD_LEXIKON_INTENTRYFOUND, $xoopsConfig['sitename']) . ': ' . $variable['term'] . ' ' . XOOPS_URL . '/modules/' . $xoopsModule->dirname() . '/entry.php?entryID=' . $variable['id']
                 . " \" target=\"_blank\"><img src=\"assets/images/friend.gif\" border=\"0\" alt=\"" . _MD_LEXIKON_SENDTOFRIEND . "\" align=\"absmiddle\" width=\"16\" height=\"16\" hspace=\"2\" vspace=\"4\"> " . _MD_LEXIKON_SENDTOFRIEND2
                 . '</a>&nbsp;';
...
{
    $chars['in']  = chr(128) . chr(131) . chr(138) . chr(142) . chr(154) . chr(158) . chr(159) . chr(162) . chr(165) . chr(181) . chr(192) . chr(193) . chr(194) . chr(195) . chr(196) . chr(197) . chr(199) . chr(200) . chr(201) . chr(202) . chr(203)
                    . chr(204) . chr(205) . chr(206) . chr(207) . chr(209) . chr(210) . chr(211) . chr(212) . chr(213) . chr(214) . chr(216) . chr(217) . chr(218) . chr(219) . chr(220) . chr(221) . chr(224) . chr(225) . chr(226) . chr(227) . chr(228)
                    . chr(229) . chr(231) . chr(232) . chr(233) . chr(234) . chr(235) . chr(236) . chr(237) . chr(238) . chr(239) . chr(241) . chr(242) . chr(243) . chr(244) . chr(245) . chr(246) . chr(248) . chr(249) . chr(250) . chr(251) . chr(252)
                    . chr(253) . chr(255);
