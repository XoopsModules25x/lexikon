...
define("_MI_LEXIKON_SUB_SMNAME0","Админ-панель");
...
define("_MI_LEXIKON_SYNDICATION","$cf. Включить поделиться ссылкой в модуле и т.д.?");
define("_MI_LEXIKON_SYNDICATIONDSC","Если установить эту опцию в «Да», пользователи будут иметь доступ к ссылке на контент модуля.");
