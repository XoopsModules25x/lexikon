...
define('_MI_LEXIKON_ADMINPAGER', 'Admin: records / page');
define('_MI_LEXIKON_ADMINPAGER_DESC', 'Admin: # of records shown per page');
define('_MI_LEXIKON_USERPAGER', 'User: records / page');
define('_MI_LEXIKON_USERPAGER_DESC', 'User: # of records shown per page');
...
// The name of this module
//define('_MI_LEXIKON_NAME', 'YYYYY Module Name');
...
//define('_MI_LEXIKON_REQUIREMENTS', 'Requirements');
//define('_MI_LEXIKON_CREDITS', 'Credits');
//define('_MI_LEXIKON_HOWTO', 'How To');
//define('_MI_LEXIKON_UPDATE', 'Update');
//define('_MI_LEXIKON_INSTALL', 'Install');
//define('_MI_LEXIKON_HISTORY', 'History');
