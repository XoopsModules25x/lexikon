...
define('_MD_LEXIKON_ANDORALL', 'Alle W&ouml;rter (UND)');
define('_MD_LEXIKON_ANDORANY', 'Jegliche W&ouml;rter (ODER)');
...
define('_MD_LEXIKON_ASKFORDEF', 'Eine Definition anfordern');
define('_MD_LEXIKON_BEGINWITHLETTER', 'Eintr&auml;ge die mit diesem Buchstaben anfangen.');
...
define('_MD_LEXIKON_DEFINITIONREQ', 'Glossar-Definitionsanfrage');
...
define('_MD_LEXIKON_DELTERM', 'Diesen Begriff l&ouml;schen');
...
define('_MD_LEXIKON_ENTRIES', ' Eintr&auml;ge.');
define('_MD_LEXIKON_ENTRIESINCAT', 'Eintr&auml;ge in diesem Verzeichnis.');
...
define('_MD_LEXIKON_ENTRYRELATEDURL', 'Verkn&uuml;pfte Seite: ');
...
define('_MD_LEXIKON_INALLGLOSSARIES', 'Eintr&auml;ge in all Ihren Glossaren.');
...
define('_MD_LEXIKON_NOENTRIESINCAT', 'Es liegen f&uuml;r diese Kategorie noch keine Eintr&auml;ge vor.');
define('_MD_LEXIKON_NORESULTS', 'Es gibt keine &Uuml;bereinstimmungen mit dem Suchbegriff. Versuchen Sie einen anderen Suchbegriff.');
...
define('_MD_LEXIKON_RANDOMTERM', 'Zuf&auml;lliger Begriff');
...
define('_MD_LEXIKON_REQUESTDEF', 'Definition anfragen');
define('_MD_LEXIKON_REQUESTFORM', 'Eine Definition anfragen');
define('_MD_LEXIKON_REQUESTSENT', 'Ihre Anfrage wurde weitergeleitet an den Webmaster von %s.');
define('_MD_LEXIKON_RETURN', 'Zur&uuml;ck');
define('_MD_LEXIKON_RETURN2INDEX', 'Zur&uuml;ck zum Index');
define('_MD_LEXIKON_SEARCH', 'Suchen!');
define('_MD_LEXIKON_SEARCHENTRY', 'Suche nach Eintrag');
define('_MD_LEXIKON_SEARCHHEAD', 'Suchergebnisse');
define('_MD_LEXIKON_SECTIONNAME', 'W&ouml;rterbuch');
...
define('_MD_LEXIKON_UNKNOWNERROR', 'FEHLER. Sie werden zur&uuml;ckgeleitet!');
define('_MD_LEXIKON_URL', "URL<BR><span style='font-size: x-small; font-weight: normal; display: block;line-height:1em;'>(Bitte geben Sie eine g&uuml;ltige URL mit oder ohne HTTP-Pr&auml;fix an)</span>");
...
define('_MD_LEXIKON_BREAKS', 'Zeilenumbr&uuml;che erlauben?');
...
define('_MD_LEXIKON_BKMK_TO_BLINKLIST', 'Bei Blinklist eintragen');
define('_MD_LEXIKON_BKMK_TO_DELICIOUS', 'Bei delicious eintragen');
define('_MD_LEXIKON_BKMK_TO_DIGG', 'Bei Digg eintragen');
define('_MD_LEXIKON_BKMK_TO_NEWSVINE', 'Bei Newsvine eintragen');
define('_MD_LEXIKON_BKMK_TO_REDDIT', 'Bei Reddit eintragen');
define('_MD_LEXIKON_BKMK_TO_GOOGLE', 'Bei Google Bookmarks eintragen');
define('_MD_LEXIKON_BKMK_TO_TECHNORATI', 'Bei Technorati eintragen');
define('_MD_LEXIKON_BKMK_TO_FARK', 'Bei Fark eintragen');
define('_MD_LEXIKON_BKMK_TO_FACEBOOK', 'mit Facebook-Freunden teilen');
define('_MD_LEXIKON_BKMK_TO_TWITTER', 'Twittern');
...
define('_MD_LEXIKON_CONTRIBUTORSLIST', 'Hier eine Liste der Autoren des Lexikons dieser Site. <BR>Klicken Sie den Benutzernamen um ihre/seine Beiträge zu sehen.');
...
define('_MD_LEXIKON_PM', 'Private Nachricht');
define('_MD_LEXIKON_LOCATION', 'Wohnort');
define('_MD_LEXIKON_WWW', 'Website');
//webmastercontent
...
define('_MD_LEXIKON_CONFMOD', '&Auml;nderung übernommen!');
