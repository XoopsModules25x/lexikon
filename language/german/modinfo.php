...
define('_MI_LEXIKON_MULTICATS', "$cf. Benötigen Sie Glossar-Kategorien?");
...
define('_MI_LEXIKON_ALLOWSUBMIT', "$cf. Dürfen User Einträge einschicken?");
define('_MI_LEXIKON_ALLOWSUBMITDSC', "Falls 'Ja', haben die User Zugriff auf das Absendeformular");

++$cf;

define('_MI_LEXIKON_CATSINMENU', "$cf. Sollen die Kategorien im Menü angezeigt werden?");
define('_MI_LEXIKON_CATSINMENUDSC', "Wählen Sie 'Ja', falls Sie Links zu Kategorien im Hauptmenü haben wollen.");

define('_MI_LEXIKON_ANONSUBMIT', "$cf. Dürfen Gäste Einträge einschicken?");
...
define('_MI_LEXIKON_AUTOAPPROVE', "$cf. Einträge automatisch freigeben?");
define('_MI_LEXIKON_AUTOAPPROVEDSC', "Falls 'Ja' werden die eingesendeten Einträge automatisch freigegeben.");

++$cf;

define('_MI_LEXIKON_ALLOWADMINHITS', "$cf. Sollen Admin-Aufrufe mitgezählt werden?");
...
define('_MI_LEXIKON_RANDOMLENGTH', "$cf. Länge der anzuzeigenden Zeile bei zufälligen Definitionen?");
...
++$cf;
define('_MI_LEXIKON_SHOWDAT', "$cf. Zeige Datum im Block der neuesten Einträge?");
define('_MI_LEXIKON_SHOWDATDSC', "Falls 'Ja' wird auf der Startseite das Datum bei den neuesten Einträgen gezeigt.");
++$cf;
define('_MI_LEXIKON_SHOWCTR', "$cf. Zeige Counter im Block der beliebtesten Einträge?");
define('_MI_LEXIKON_SHOWCTRDSC', "Falls 'Ja' wird der Zähler auf der Startseite bei populärsten Einträgen gezeigt.");
++$cf;
define('_MI_LEXIKON_CAPTCHA', "$cf. Captcha für Einsendungen verwenden?");
define('_MI_LEXIKON_CAPTCHADSC', 'Xoops Frameworks wird benötigt.');
++$cf;
define('_MI_LEXIKON_KEYWORDS_HIGH', "$cf. Suchwörter farblich hervorheben ?");
...
++$cf;
define('_MI_LEXIKON_LOGOWIDTH', "$cf. Breite der Kategoriebilder im Menü:");
...
++$cf;
define('_MI_LEXIKON_RSS', "$cf. Dürfen Gäste RSS Syndikation benutzen?");
...
$cf++;
define('_MI_LEXIKON_IMGUPLOADWD', "$cf. Maximale Höhe/Breite für Bilderupload");
define('_MI_LEXIKON_IMGUPLOADWD_DESC', 'Setzt die maximale erlaubte Höhe/Breite für das Hochladen eines Bildes.');
$cf++;
define('_MI_LEXIKON_IMGUPLOADSIZE', "$cf. Maximale Dateigröße für Bilderupload");
...
define('_MI_LEXIKON_BACK_2_ADMIN', 'Zurück zur Administration von ');
define('_MI_LEXIKON_HELP_OVERVIEW', 'Überblick');
...
define('_MI_LEXIKON_ADMINPAGER', 'Admin: Einträge / Seiten');
define('_MI_LEXIKON_ADMINPAGER_DESC', 'Admin: Anzahl Einträge pro Seite');
define('_MI_LEXIKON_USERPAGER', 'User: Einträge / Seiten');
define('_MI_LEXIKON_USERPAGER_DESC', 'User: Anzahl Einträge pro Seite');
...
//define('_MI_LEXIKON_HELP_DIR', __DIR__);

//help multi-page
define('_MI_LEXIKON_DISCLAIMER', 'Disclaimer');
define('_MI_LEXIKON_LICENSE', 'License');
define('_MI_LEXIKON_SUPPORT', 'Support');
//define('_MI_LEXIKON_REQUIREMENTS', 'Anforderungen');
//define('_MI_LEXIKON_CREDITS', 'Credits');
//define('_MI_LEXIKON_HOWTO', 'Wie funktioniert');
//define('_MI_LEXIKON_UPDATE', 'Aktualisieren');
//define('_MI_LEXIKON_INSTALL', 'Installation');
//define('_MI_LEXIKON_HISTORY', 'Historie');
//define('_MI_LEXIKON_HELP1', 'YYYYY');
//define('_MI_LEXIKON_HELP2', 'YYYYY');
//define('_MI_LEXIKON_HELP3', 'YYYYY');
//define('_MI_LEXIKON_HELP4', 'YYYYY');
//define('_MI_LEXIKON_HELP5', 'YYYYY');
//define('_MI_LEXIKON_HELP6', 'YYYYY');
