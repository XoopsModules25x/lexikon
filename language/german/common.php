...
\define('CO_' . $moduleDirNameUpper . '_' . 'UPDATE_SUCCESS', 'Update erfolgreich');
...
\define('CO_' . $moduleDirNameUpper . '_' . 'MIGRATE_OK', 'Datenbank zu aktuellem Schema migriert.');
\define('CO_' . $moduleDirNameUpper . '_' . 'MIGRATE_WARNING', 'Achtung! Diese Funktionalität ist nur für Entwickler. Bestätigen Sie das Schreiben der Schema-Datei der aktuellen Datenbank.');
\define('CO_' . $moduleDirNameUpper . '_' . 'MIGRATE_SCHEMA_OK', 'Schema-Datei der aktuellen Datenbank erstellt');
...
\define('CO_' . $moduleDirNameUpper . '_' . 'IMAGE_FILE_SIZE', 'Dateigröße einer Bilddatei (in Bytes)');
\define('CO_' . $moduleDirNameUpper . '_' . 'IMAGE_FILE_SIZE_DSC', 'Die maximale Dateigröße der Bilddatei (in Bytes)');
