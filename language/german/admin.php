...
//Index
define('AM_LEXIKON_STATISTICS', 'Lexikon Statistiken');
define('AM_LEXIKON_THEREARE_CATEGORY', "Es gibt <span class='bold'>%s</span> Kategorien in der Datenbank");
define('AM_LEXIKON_THEREARE_ENTRIES', "Es gibt <span class='bold'>%s</span> Einträge in der Datenbank");
//Buttons
define('AM_LEXIKON_ADD_CATEGORIES', 'Neue Kategorie hinzufügen');
define('AM_LEXIKON_CATEGORIES_LIST', 'Liste der Kategorien');
define('AM_LEXIKON_ADD_ENTRIES', 'Neuen Eintrag hinzufügen');
define('AM_LEXIKON_ENTRIES_LIST', 'Liste der Einträge');
//General
define('AM_LEXIKON_FORMOK', 'Erfolgreich registriert');
define('AM_LEXIKON_FORMDELOK', 'Erfolgreich gelöscht');
define('AM_LEXIKON_FORMSUREDEL', "Wollen Sie wirklich löschen: <span class='bold red'>%s</span></b>");
define('AM_LEXIKON_FORMSURERENEW', "Wollen Sie wirklich erneuern: <span class='bold red'>%s</span></b>");
define('AM_LEXIKON_FORMUPLOAD', 'Hochladen');
define('AM_LEXIKON_FORMIMAGE_PATH', 'In %s vorhandene Dateien');
define('AM_LEXIKON_FORM_ACTION', 'Aktion');
define('AM_LEXIKON_SELECT', 'Aktion(en) für ausgewählte Elemente ausführen');
define('AM_LEXIKON_SELECTED_DELETE', 'Ausgewählte Elemente löschen');
define('AM_LEXIKON_SELECTED_ACTIVATE', 'Ausgewählte Elemente aktivieren');
define('AM_LEXIKON_SELECTED_DEACTIVATE', '(De-)Aktivierung ausgewählte Elemente');
define('AM_LEXIKON_SELECTED_ERROR', 'Sie haben keine Auswahl getroffen');
define('AM_LEXIKON_CLONED_OK', 'Datensatz erfolgreich gecloned');
define('AM_LEXIKON_CLONED_FAILED', 'Datensatz clonen fehlgeschlagen');

// Categories
define('AM_LEXIKON_CATEGORIES_ADD', ' Kategorien hinzufügen');
define('AM_LEXIKON_CATEGORIES_EDIT', 'Kategorie bearbeiten');
define('AM_LEXIKON_CATEGORIES_DELETE', 'Kategorie löschen');
define('AM_LEXIKON_CATEGORIES_CATEGORYID', 'Id');
define('AM_LEXIKON_CATEGORIES_NAME', 'Kategorien');
define('AM_LEXIKON_CATEGORIES_DESCRIPTION', 'Beschreibung');
define('AM_LEXIKON_CATEGORIES_TOTAL', 'Kategorien gesamt');
define('AM_LEXIKON_CATEGORIES_WEIGHT', 'Reihung');
define('AM_LEXIKON_CATEGORIES_LOGOURL', 'Logo URL');
// Entries
define('AM_LEXIKON_ENTRIES_ADD', 'Eintrag hinzufügen');
define('AM_LEXIKON_ENTRIES_EDIT', 'Eintrag bearbeiten');
define('AM_LEXIKON_ENTRIES_DELETE', 'Eintrag löschen');
define('AM_LEXIKON_ENTRIES_ENTRYID', 'Id');
define('AM_LEXIKON_ENTRIES_CATEGORYID', 'Kategorien');
define('AM_LEXIKON_ENTRIES_TERM', 'Begriff');
define('AM_LEXIKON_ENTRIES_INIT', 'Initialisieren');
define('AM_LEXIKON_ENTRIES_DEFINITION', 'Definition');
define('AM_LEXIKON_ENTRIES_REF', 'Referenz');
define('AM_LEXIKON_ENTRIES_URL', 'URL');
define('AM_LEXIKON_ENTRIES_UID', 'Benutzer');
define('AM_LEXIKON_ENTRIES_SUBMIT', 'Einsender');
define('AM_LEXIKON_ENTRIES_DATESUB', 'Eingesendet');
define('AM_LEXIKON_ENTRIES_COUNTER', 'Zähler');
define('AM_LEXIKON_ENTRIES_HTML', 'Html');
define('AM_LEXIKON_ENTRIES_SMILEY', 'Smilie');
define('AM_LEXIKON_ENTRIES_XCODES', 'xCodes');
define('AM_LEXIKON_ENTRIES_BREAKS', 'Zeilenumbruch');
define('AM_LEXIKON_ENTRIES_BLOCK', 'Block');
define('AM_LEXIKON_ENTRIES_OFFLINE', 'Offline');
define('AM_LEXIKON_ENTRIES_NOTIFYPUB', 'Bei Veröffentlichung benachrichtigen');
define('AM_LEXIKON_ENTRIES_REQUEST', 'Anfrage');
define('AM_LEXIKON_ENTRIES_COMMENTS', 'Kommentare');
define('AM_LEXIKON_ENTRIES_ITEM_TAG', 'Tag');
define('AM_LEXIKON_ENTRIES_ONLINE', 'Online');
//Blocks.php
//Permissions
define('AM_LEXIKON_PERMISSIONS_GLOBAL', 'Globale Berechtigungen');
define('AM_LEXIKON_PERMISSIONS_GLOBAL_DESC', 'Nur Benutzer von der von Ihnen ausgewählten Gruppe dürfen dies');
define('AM_LEXIKON_PERMISSIONS_GLOBAL_4', 'Bewertung von User');
define('AM_LEXIKON_PERMISSIONS_GLOBAL_8', 'Eingesendet von Benutzerseite');
define('AM_LEXIKON_PERMISSIONS_GLOBAL_16', 'Automatische Freigabe');
define('AM_LEXIKON_PERMISSIONS_APPROVE', 'Berechtigung zu Freigabe');
define('AM_LEXIKON_PERMISSIONS_APPROVE_DESC', 'Nur Benutzer von der von Ihnen ausgewählten Gruppe dürfen dies');
define('AM_LEXIKON_PERMISSIONS_VIEW', 'Berechtigung zum Ansehen');
define('AM_LEXIKON_PERMISSIONS_VIEW_DESC', 'Nur Benutzer von der von Ihnen ausgewählten Gruppe dürfen dies');
define('AM_LEXIKON_PERMISSIONS_SUBMIT', 'Berechtigung zum Einsenden');
define('AM_LEXIKON_PERMISSIONS_SUBMIT_DESC', 'Nur Benutzer von der von Ihnen ausgewählten Gruppe dürfen dies');
define('AM_LEXIKON_PERMISSIONS_GPERMUPDATED', 'Berechtigungen erfolgreich geändert');
define('AM_LEXIKON_PERMISSIONS_NOPERMSSET', 'Berechtigungen konnten nicht gesetzt werden. Grund: Noch keine Einträge vorhanden! Bitte zuerst einen Eintrag erstellen.');

//Errors
define('AM_LEXIKON_UPGRADEFAILED0', "Update fehlgeschlagen - konnte Feld '%s' nicht umbenennen");
define('AM_LEXIKON_UPGRADEFAILED1', "Update fehlgeschlagen - konnte neues Feld nicht erstellen");
define('AM_LEXIKON_UPGRADEFAILED2', "Update fehlgeschlagen - konnte Feld '%s' nicht umbenennen");
define('AM_LEXIKON_ERROR_COLUMN', 'Konnte Spalte in Datenbasis nicht erstellen: %s');
define('AM_LEXIKON_ERROR_BAD_XOOPS', 'Dieses Modul benötigt XOOPS %s+ (%s installiert)');
define('AM_LEXIKON_ERROR_BAD_PHP', 'Dieses Modul benötigt PHP Version %s+ (%s installiert)');
define('AM_LEXIKON_ERROR_TAG_REMOVAL', 'Konnte Tags vom Tag-Modul nicht entfernen');
//directories
define('AM_LEXIKON_AVAILABLE', "<span style='color : green;'>Verfügbar. </span>");
define('AM_LEXIKON_NOTAVAILABLE', "<span style='color : red;'>nicht verfügbar. </span>");
define('AM_LEXIKON_NOTWRITABLE', "<span style='color : red;'>" . ' should have permission ( %1$d ), but it has ( %2$d )' . '</span>');
define('AM_LEXIKON_CREATETHEDIR', 'Erstellen');
define('AM_LEXIKON_SETMPERM', 'Berechtigung setzen');
define('AM_LEXIKON_DIRCREATED', 'Das Verzeichnis wurde erstellt');
define('AM_LEXIKON_DIRNOTCREATED', 'Das Verzeichnis konnte nicht erstellt werden');
define('AM_LEXIKON_PERMSET', 'Die Berechtigungen wurden erteilt');
define('AM_LEXIKON_PERMNOTSET', 'Die Berechtigungen konnten nicht erteilt werden');
define('AM_LEXIKON_VIDEO_EXPIREWARNING', 'Das Veröffentlichungsdatum ist nach dem Ablaufdatum!!!');
//Sample Data
define('AM_LEXIKON_LOAD_SAMPLEDATA', 'Import Beispieldaten (ALLE aktuellen Daten werden gelöscht)');
define('AM_LEXIKON_SAMPLEDATA_SUCCESS', 'Beispieldaten erfolgreich geladen');

define('AM_LEXIKON_MAINTAINEDBY', 'wird unterstützt von ');
...
define('AM_CATEGORIES_SELECTED_ERROR', 'Sie haben keine Auswahl getroffen');
