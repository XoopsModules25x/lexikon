 ...
 * Licence: GNU
 */
define("_AM_LEXIKON_ACTION","Aktion");
define("_AM_LEXIKON_ADMINCATMNGMT","Kategoriemanagement");
define("_AM_LEXIKON_ADMINENTRYMNGMT","Eintragmanagement");
define("_AM_LEXIKON_ALLOWCOMMENTS","D&uuml;rfen Eintr&auml;ge kommentiert werden?");
define("_AM_LEXIKON_ANON","G&auml;ste");
define("_AM_LEXIKON_AUTHENTRY","Einsendung autorisieren");
define("_AM_LEXIKON_AUTHOR","Autor");
define("_AM_LEXIKON_AUTHORIZE","Autorisieren");
define("_AM_LEXIKON_BACK2IDX","Abgebrochen. Zur&uuml;ck zum Index");
define("_AM_LEXIKON_BLOCK"," Dem Eintrag-Block hinzuf&uuml;gen?");
define("_AM_LEXIKON_BLOCKS","Bl&ouml;cke");
...
define("_AM_LEXIKON_CATDESCRIPT","Kategoriebeschreibung");
define("_AM_LEXIKON_CATIMAGE","Kategoriebild");
define("_AM_LEXIKON_CATIMAGEUPLOAD"," Kategoriebild hochladen");
define("_AM_LEXIKON_CATISDELETED","Kategorie %s wurde gel&ouml;scht");
define("_AM_LEXIKON_CATMODIFIED","Gew&auml;hlte Kategorie wurde ver&auml;ndert und gespeichert!");
define("_AM_LEXIKON_CATNAME","[*] Kategoriename");
define("_AM_LEXIKON_CATPOSIT","[*] Kategorieposition");
define("_AM_LEXIKON_CATS","Kategorien");
define("_AM_LEXIKON_CATSHEADER","KategorieManagement");
define("_AM_LEXIKON_CLEAR","Zur&uuml;cksetzen");
...
define("_AM_LEXIKON_DELETE","L&ouml;schen");
define("_AM_LEXIKON_DELETECAT","Kategorie l&ouml;schen");
define("_AM_LEXIKON_DELETEENTRY","Eintrag l&ouml;schen");
define("_AM_LEXIKON_DELETESUBM","Einsendung l&ouml;schen");
define("_AM_LEXIKON_DELETETHISCAT","Sind Sie sicher Sie wollen diese Kategorie l&ouml;schen?");
define("_AM_LEXIKON_DELETETHISENTRY","Diesen Eintrag l&ouml;schen?");
define("_AM_LEXIKON_DESCRIP","Kategoriebeschreibung");
...
define("_AM_LEXIKON_ENTRIES","Eintr&auml;ge");
define("_AM_LEXIKON_ENTRYAUTHORIZED","Der Eintrag wurde autorisiert.");
define("_AM_LEXIKON_ENTRYCATNAME","Kategoriename");
define("_AM_LEXIKON_ENTRYCREATED","Erstellt");
...
define("_AM_LEXIKON_ENTRYISDELETED","Der Eintrag %s wurde gel&ouml;scht.");
...
define("_AM_LEXIKON_INVENTORY","Eintragzusammenfassung");
define("_AM_LEXIKON_MODCAT","Vorhandene Kategorie ver&auml;ndern");
define("_AM_LEXIKON_MODADMIN"," Modul-Admin: ");
define("_AM_LEXIKON_MODENTRY","Eintrag ver&auml;ndern");
define("_AM_LEXIKON_MODIFY","Ver&auml;ndern");
define("_AM_LEXIKON_MODIFYCAT","Kategorie ver&auml;ndern");
define("_AM_LEXIKON_MODIFYTHISCAT","Diese Kategorie ver&auml;ndern?");
define("_AM_LEXIKON_MODULEHEADMULTI","Eintr&auml;ge | Kategorien | Einsendungen | Anfragen");
define("_AM_LEXIKON_MODULEHEADSINGLE","Eintr&auml;ge | Einsendungen | Anfragen");
define("_AM_LEXIKON_NEEDONECOLUMN","Um einen Eintrag zu erstellen, wird wenigstens eine Kategorie ben&ouml;tigt.");
...
define("_AM_LEXIKON_NOPERMSSET","Berechtigungen k&ouml;nnen nicht gesetzt werden: Keine Spalten bis jetzt erstellt!");
...
define("_AM_LEXIKON_SHOWENTRIES","Eintr&auml;ge");
...
define("_AM_LEXIKON_SUBMITTER","Absender");
define("_AM_LEXIKON_SWITCHOFFLINE"," Eintrag offline setzen?");
define("_AM_LEXIKON_TOTALCATS","Verf&uuml;gbare Kategorien: ");
define("_AM_LEXIKON_TOTALENTRIES","Ver&ouml;ffentlichte Eintr&auml;ge: ");
define("_AM_LEXIKON_TOTALREQ","Angefragte Eintr&auml;ge: ");
define("_AM_LEXIKON_TOTALSUBM","Eingeschickte Eintr&auml;ge: ");
define("_AM_LEXIKON_UNIQUE","Einmalige Kategorie");
define("_AM_LEXIKON_WEIGHT","Position");
define("_AM_LEXIKON_WRITEHERE","Schreiben Sie hier die Definition.");
...
define("_AM_LEXIKON_ABOUT_AUTHOR","Autor");
...
define("_AM_LEXIKON_ABOUT_SUBMIT_BUG","Bugreport für dieses Modul einsenden");
...
define("_AM_LEXIKON_MODULEHEADIMPORTXWO","XWords &mdash;&gt; Lexikon Import Skript");
define("_AM_LEXIKON_MODULEHEADIMPORTWW","Wiwimod &mdash;&gt; Lexikon Import Skript");
...
define("_AM_LEXIKON_NOOTHERMODS","<font size=1>No corresponding modules could be located!</font>");
// upgrade
define("_AM_LEXIKON_PLEASE_UPGRADE",'<font color=\'#FF0000\'>Bitte Modul updaten!</font></a>');
define("_AM_LEXIKON_UPGRADECOMPLETE","Füge neues Feld hinzu.<BR> Upgrade erfolgreich beendet<BR><BR>");
define("_AM_LEXIKON_UPGRADEFAILED","Failed fehlgeschlagen!");
define("_AM_LEXIKON_UPGRADE","Upgrade");
define("_AM_LEXIKON_UPGRADEFAILED1","Impossible to create field ");
...
define("_AM_LEXIKON_STATS","Statistik");
...
define("_AM_LEXIKON_ALLITEMSMSG","W&auml;hlen Sie einen Status aus, um Begriffe mit den gewünschten Merkmalen aufzulisten.");
...
define("_AM_LEXIKON_PUBLISHED","Ver&ouml;ffentlicht");
define("_AM_LEXIKON_PUBLISHED_EXP","<b>Ve&ouml;ffentlichte Begriffe</b> : Freigeschaltete Begriffe die dem Benutzer dargestellt werden.");
...
define("_AM_LEXIKON_VIEWFORM","Lesen");
